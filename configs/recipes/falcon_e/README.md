...
* **tiiuae/Falcon-E-1B-\[Base|Instruct]**
  [Base](https://huggingface.co/tiiuae/Falcon-E-1B-Base), [Instruct](https://huggingface.co/tiiuae/Falcon-E-1B-Base-Instruct), [Instruct (GGUF)](https://huggingface.co/tiiuae/Falcon-E-1B-Base-Instruct-GGUF),
* **tiiuae/Falcon-E-3B-\[Base|Instruct]**
  [Base](https://huggingface.co/tiiuae/Falcon-E-3B-Base), [Instruct](https://huggingface.co/tiiuae/Falcon-E-3B-Instruct), [Instruct (GGUF)](https://huggingface.co/tiiuae/Falcon-E-3B-Base-Instruct-GGUF)
...
> [!IMPORTANT]
> If you are running Falcon-E locally, you will need to set up additional Python library dependencies. Please run the `pip` and `uv` commands under the `-setup` section of the [remote job configs](https://github.com/oumi-ai/oumi/blob/main/configs/recipes/falcon_h1/evaluation/falcon_h1_0_5b/lambda_job.yaml#L36-L43).
...
Evaluate Falcon-H1-E-Instruct locally:
